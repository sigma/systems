...
(use-package! windmove
  :config
  ;; Smart window/pane navigation with edge detection.
  ;; If at window edge, delegate to terminal multiplexer (WezTerm or tmux).
...
DIRECTION is a string: left, right, up, down."
  ...
  (map! "C-c <left>"  #'my/pane-move-left
        "C-c <right>" #'my/pane-move-right
        "C-c <up>"    #'my/pane-move-up
        "C-c <down>"  #'my/pane-move-down))
#+end_src
*** Notmuch
:PROPERTIES:
