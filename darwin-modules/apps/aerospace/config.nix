...
in ''  # Generated by nix
  ...
  ${
    if borders
    then "'exec-and-forget ${brewPrefix}/borders active_color=0xffe2e2e3 inactive_color=0xff414550 width=6.0 style=round'"
    else ""
  }
  ]
  ...
  ${mods.primary}-enter = 'exec-and-forget ${brewPrefix}/wezterm start --always-new-process --cwd ~'
